...
const PREDICT_API_URL = process.env.PREDICT_API_URL || 'https://macular-patrimonially-olinda.ngrok-free.dev/api/vlm/predict';
const RECOMMEND_API_URL = process.env.RECOMMEND_API_URL || 'https://macular-patrimonially-olinda.ngrok-free.dev/api/vlm/recommend';
